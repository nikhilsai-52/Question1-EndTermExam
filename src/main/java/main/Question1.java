...
public class Question1 {
	public static void main(String[] args){
		...
		case 2:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			Mechanical obj1 = new Mechanical();
			System.out.println(obj1.displayCourseDetails("Mechanical"));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			CSE obj2 = new CSE();
			System.out.println(obj2.displayCourseDetails("CSE"));//call the function of the class that you initialized
			break;
		}
		default:
